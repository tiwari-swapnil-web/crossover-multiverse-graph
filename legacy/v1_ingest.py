...
def run_v1_ingestion():
    """Runs the complete V1 local text file ingestion pipeline."""
    print("📜 [V1 Baseline Engine] Starting offline franchise ingestion...")
    extract_all_franchise_names()
    filter_franchise_names()
    load_into_sqlite()
    print("✅ [V1 Baseline Engine] Franchises loaded into database!")
